...
public class MovieListLoader extends AsyncTaskLoader<ArrayList<MovieResponse.Movie>> {
    ...
    protected void onStartLoading() {
        ...
        if (mFavoriteIds == null || mFavoriteIds.size() == 0) {
            deliverResult(new ArrayList<MovieResponse.Movie>());
        } else {
            forceLoad();
        }
    }
    ...
    @Override
    public ArrayList<MovieResponse.Movie> loadInBackground() {
        ...
        if (null == cursor) {
            ...
            ArrayList<MovieResponse.Movie> movies = new ArrayList<>();
    ...
    @Override
    public void deliverResult(ArrayList<MovieResponse.Movie> data) {
